    ...
    <section id="modal-1" class="modal-container">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <!-- <embed src="http://localhost/C.S.J.O.bo/plantillaPantalla\videoPantalla\videoFarmacia.mp4" type="video/mp4" height="300" > -->
                <iframe src="http://localhost/C.S.J.O.bo/plantillaPantalla\videoPantalla\videoFarmacia.mp4" width="640" height="360" frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
                <table>
                    <thead>
                        <tr>
                            <th>asdf</th>
